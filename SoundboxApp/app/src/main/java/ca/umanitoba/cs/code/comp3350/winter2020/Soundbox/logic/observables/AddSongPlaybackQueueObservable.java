...
public class AddSongPlaybackQueueObservable extends SoundboxObservable<Song> {
    private Song song;
    ...
    /**
     *
     * @return Returns the song that was added. If more than one song was added returns null
     */
    @Override
