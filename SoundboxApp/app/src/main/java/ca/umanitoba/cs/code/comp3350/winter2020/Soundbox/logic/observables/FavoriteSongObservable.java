...
public class FavoriteSongObservable extends SoundboxObservable<Song> {
    Song song;
    ...
    /**
     *
     * @return Returns the song that was favorited. If more than one song was added returns null
     */
    @Override
