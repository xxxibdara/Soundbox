...
public class FavoriteSongObservableTests {

    @Before
    public void setUp() {
        System.out.println("Starting unit tests for FavoriteSongObservable.");
    }

    @Test
    public void testObservable() {
        FavoriteSongObservable observable = new FavoriteSongObservable();
    ...
    public void tearDown() {
        System.out.println("Finished unit tests for FavoriteSongObservable.");
    }
