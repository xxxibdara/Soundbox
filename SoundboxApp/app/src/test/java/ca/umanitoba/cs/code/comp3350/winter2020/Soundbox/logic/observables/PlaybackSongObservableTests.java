...
public class PlaybackSongObservableTests {

    @Before
    public void setUp() {
        System.out.println("Starting unit tests for PlaybackSongObservable.");
    }

    @Test
    public void testObservable(){
        PlaybackSongObservable observable = new PlaybackSongObservable();
    ...
    public void tearDown() {
        System.out.println("Finished unit tests for PlaybackSongObservable.");
    }
