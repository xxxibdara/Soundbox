...
public class DeleteSongPlaybackQueueObservableTests {

    @Before
    public void setUp() {
        System.out.println("Starting unit tests for DeleteSongPlaybackQueueObservable.");
    }

    @Test
    public void testObservable() {
        DeleteSongPlaybackQueueObservable observable = new DeleteSongPlaybackQueueObservable();
    ...
    public void tearDown() {
        System.out.println("Finished unit tests for DeleteSongPlaybackQueueObservable.");
    }
